...
INSERT INTO [group_member] VALUES ((SELECT group_number FROM groups WHERE name = 'Moe''s Bar'), (SELECT member_number FROM members WHERE last_name = 'Simpson' AND first_name = 'Homer'))
...
INSERT INTO [group_member] VALUES ((SELECT group_number FROM groups WHERE name = 'First Church of Springfield'), (SELECT member_number FROM members WHERE last_name = 'Simpson' AND first_name = 'Homer'))
...
INSERT INTO [event_member] VALUES ((SELECT event_number FROM events WHERE name = 'Softball Game'), (SELECT member_number FROM members WHERE last_name = 'Gumble' AND first_name = 'Barney'))
INSERT INTO [event_member] VALUES ((SELECT event_number FROM events WHERE name = 'Softball Game'), (SELECT member_number FROM members WHERE last_name = 'Flanders' AND first_name = 'Ned'))
...
INSERT INTO [event_member] VALUES ((SELECT event_number FROM events WHERE name = 'Pin Pals Bowling Night'), (SELECT member_number FROM members WHERE last_name = 'Burns' AND first_name = 'Montgomery'))
...
INSERT INTO [event_member] VALUES ((SELECT event_number FROM events WHERE name = 'Yearly Inspection'), (SELECT member_number FROM members WHERE last_name = 'Leonard' AND first_name = 'Lenny'))
INSERT INTO [event_member] VALUES ((SELECT event_number FROM events WHERE name = 'Yearly Inspection'), (SELECT member_number FROM members WHERE last_name = 'Carlson' AND first_name = 'Carl'))

...
SELECT 2 + 2 AS sum_of_two_numbers;
...
FROM city
WHERE state_abbreviation <> 'CA'; --or use !=
...
FROM city
WHERE area < 25; --assuming column is in kn squared
...
SELECT park_name, area, area * 100000000 AS area_in_meters
FROM park;
